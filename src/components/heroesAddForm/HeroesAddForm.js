...
const HeroesAddForm = () => {
    ...
    const onSubmitHandler = (e) => {
        ...
        request("http://localhost:3001/heroes", "POST", JSON.stringify(newHero))
            .then(res => console.log(res, 'Send successful'))
    ...
    return (
        <form className="border p-4 shadow-lg rounded" onSubmit={onSubmitHandler}>
            ...
            <div className="mb-3">
                <label htmlFor="element" className="form-label">Choose element of the hero</label>
                <select
                    required
                    ...
                    <option value="">I have element of ...</option>
